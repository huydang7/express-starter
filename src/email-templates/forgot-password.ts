...
export const getEmailForgotPassword = (link: string) => {
  return `<!doctype html>
  <html>
  ${getHeader()}
                                  ...
                                  <tr>
                                      <td style="padding:0 35px;">
                                          ...
                                          <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                              Xin chào, chúng tôi vừa nhận được yêu cầu đặt lại mật khẩu từ
                                              tài khoản của bạn trên hệ thống.
                                          </p>
                                          <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                              Vui lòng nhấn vào nút bên dưới để đặt lại mật khẩu. Nếu hành động này không
                                              xuất phát từ bạn, hãy bỏ qua email này.
                                          </p>
                                          <a href="${link}"
                                              style="background:#FF357E;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:14px 32px;display:inline-block;border-radius:6px;">Đặt lại mật khẩu</a>
                                          </td>
                                      </tr>
                                  </tr>
                              </table>
